...
public class Opentable {
    ...
    public void test1() throws IOException, InterruptedException{
        PropertyConfigurator.configure("C:\\Users\\danus\\OneDrive\\Desktop\\softwaretesting\\modellab\\demo\\opentable\\log4j2.properties");
        FileInputStream fs = new FileInputStream("C:/Users/danus/OneDrive/Desktop/softwaretesting/modellab/demo/opentable/sec2excel.xlsx");
        ...
        driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div/div[2]/div[2]/div/article/div/article/ul/li[3]/a")).click();
        Thread.sleep(3000);

        driver.findElement(By.xpath("//*[@id=\"baseApp\"]/div/header/div[2]/div[2]/div[1]/button")).click();
        File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        String path = "C:\\Users\\danus\\OneDrive\\Desktop\\softwaretesting\\modellab\\demo\\opentable\\sec2log\\image.png";
